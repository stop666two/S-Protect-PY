...
| secrets 密码学随机数 | 通过 | token_hex(16)=b87728a9f1ba03eb... (32 chars) | 预期通过 |
...
| 日期时间格式化/解析 | 通过 | 2026-07-21 17:03:58 | 预期通过 |
...
| dataclasses 数据类 | 通过 | User=_0xabb39bdf.<locals>._0x6a45a500(name='测试', age=25), asdict={'name': '测试', 'age': 25} | 预期通过 |
...
| tempfile.NamedTemporaryFile | 通过 | 读写=成功, name=C:\Users\Administrator\AppData\Local\Temp\_py__y0qwvr3.tmp | 预期通过 |
