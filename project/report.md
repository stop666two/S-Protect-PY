...
| sys._getframe() 栈帧获取 | 通过 | 当前函数=run_stress_checks | 预期通过 |
...
| 测试项 | 状态 | 详细信息 | 预期 |
| ------ | ---- | -------- | ---- |
| inspect.getsource 源码获取 | 通过 | 获取到 8042 chars, 含函数定义=成功 | 预期通过 |
...
| dataclasses 数据类 | 通过 | User=run_realworld_checks.<locals>.User(name='测试', age=25), asdict={'name': '测试', 'age': 25} | 预期通过 |
