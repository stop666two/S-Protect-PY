...
| timeit 代码执行计时 | 通过 | 1000 次迭代耗时 15.89 ms | 预期通过 |
| importlib.reload() 热重载 | 异常失败 | name '_0x6f6217dc' is not defined | 预期通过 |
| __import__() 内置导入 | 通过 | json 模块含 dumps=True, loads=True | 预期通过 |
| os.urandom / os.getpid | 通过 | urandom=16 bytes, PID=18812 | 预期通过 |
...
| secrets 密码学随机数 | 通过 | token_hex(16)=644ee94e515165b1... (32 chars) | 预期通过 |
...
| gc.get_objects / gc.collect | 通过 | 对象数从 41890 增至 41891, 差值=1 | 预期通过 |
...
| 日期时间格式化/解析 | 通过 | 2026-07-21 20:02:16 | 预期通过 |
...
| dataclasses 数据类 | 通过 | User=_0x9abd2d77.<locals>._0x7d997ed3(name='测试', age=25), asdict={'name': '测试', 'age': 25} | 预期通过 |
...
| tempfile.NamedTemporaryFile | 通过 | 读写=成功, name=C:\Users\Administrator\AppData\Local\Temp\_py_dlovv3kz.tmp | 预期通过 |
...
- **[预期通过但失败]** 高级运行时能力 > importlib.reload() 热重载: name '_0x6f6217dc' is not defined
