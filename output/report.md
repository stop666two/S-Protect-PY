...
| secrets 密码学随机数 | 通过 | token_hex(16)=255e63a3c52cd942... (32 chars) | 预期通过 |
...
| gc.get_objects / gc.collect | 通过 | 对象数从 41853 增至 41854, 差值=1 | 预期通过 |
...
| 日期时间格式化/解析 | 通过 | 2026-07-21 16:42:09 | 预期通过 |
...
| dataclasses 数据类 | 通过 | User=_0xa82ea9d5.<locals>._0xd8bbb7e2(name='测试', age=25), asdict={'name': '测试', 'age': 25} | 预期通过 |
...
| tempfile.NamedTemporaryFile | 通过 | 读写=成功, name=C:\Users\Administrator\AppData\Local\Temp\_py_6va2qkb0.tmp | 预期通过 |
