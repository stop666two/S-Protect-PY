...
| secrets 密码学随机数 | 通过 | token_hex(16)=57f4c4b7eb887fcf... (32 chars) | 预期通过 |
...
| gc.get_objects / gc.collect | 通过 | 对象数从 41772 增至 41773, 差值=1 | 预期通过 |
...
| 日期时间格式化/解析 | 通过 | 2026-07-21 15:12:58 | 预期通过 |
...
| dataclasses 数据类 | 通过 | User=_0x3e383b6b.<locals>._0xcb9379d1(name='测试', age=25), asdict={'name': '测试', 'age': 25} | 预期通过 |
...
| tempfile.NamedTemporaryFile | 通过 | 读写=成功, name=C:\Users\Administrator\AppData\Local\Temp\_py_atn_743_.tmp | 预期通过 |
